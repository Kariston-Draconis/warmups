console.log('Random Startup Generator')
...
var randomIdea1 = thisArray[Math.floor(Math.random()*thisArray.length)]
var randomIdea2 = thatArray[Math.floor(Math.random()*thatArray.length)]

console.log(randomIdea1 + ' ' + randomIdea2)
